...
export function CollapsibleLeftSidebarNav() {
  ...
  return (
    <div className={`w-full rounded-2xl ${theme.colors.bg.card} ${theme.colors.border.primary} border shadow-lg overflow-hidden flex relative min-h-[380px]`}>
      {/* Thanh Left Sidebar trượt mượt chính xác chuẩn app */}
      <aside
        className={`bg-slate-100/80 dark:bg-slate-900/90 border-r border-slate-200 dark:border-slate-800 flex flex-col justify-between transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] ${
      ...
      {/* Khung nội dung chính minh họa ở bên phải */}
      <div className="flex-1 p-6 space-y-4">
        ...
        <p className={`text-xs ${theme.colors.text.secondary} leading-relaxed max-w-md`}>
          Mẫu Collapsible Left Sidebar chuẩn ứng dụng: Bấm nút <strong>3 gạch (☰)</strong> ở lề trái để trải nghiệm thu gọn (chỉ còn nút ☰ + Icon) và mở rộng (hiện đầy đủ Tiêu đề + Chữ + Badge + Nút Sáng/Tối).
        </p>
