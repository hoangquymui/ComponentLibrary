  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-4">
      <div className="space-y-1">
        <label className={`text-xs font-semibold ${theme.colors.text.secondary}`}>Họ và tên</label>
        <div className="relative">
          <User className={`w-5 h-5 absolute left-3.5 top-1/2 -translate-y-1/2 ${theme.colors.text.muted}`} />
          <input
            type="text"
            required
      ...
      <div className="space-y-1">
        <label className={`text-xs font-semibold ${theme.colors.text.secondary}`}>Email đăng ký</label>
        <div className="relative">
          <Mail className={`w-5 h-5 absolute left-3.5 top-1/2 -translate-y-1/2 ${theme.colors.text.muted}`} />
          <input
            type="email"
            required
      ...
      <div className="space-y-1">
        <label className={`text-xs font-semibold ${theme.colors.text.secondary}`}>Mật khẩu</label>
        <div className="relative">
